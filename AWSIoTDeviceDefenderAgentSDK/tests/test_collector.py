...
def test_collector_listening_ports(mock_net_connections, mock_io_counters, mock_if_addrs,
                                   net_connections, if_addrs, net_io_counters):
...
@mock.patch(PATCH_MODULE_LOCATION_PS + "net_io_counters")
@mock.patch(PATCH_MODULE_LOCATION_PS + "net_connections")
def test_collector_collect_network_stats(mock_net_connections, mock_io_counters, mock_if_addrs,
    net_connections, if_addrs, net_io_counters):
...
@mock.patch(PATCH_MODULE_LOCATION_PS + "net_io_counters")
@mock.patch(PATCH_MODULE_LOCATION_PS + "net_connections")
def test_collector_net_connections(mock_net_connections, mock_io_counters, mock_if_addrs,
    net_connections, if_addrs, net_io_counters):
    mock_net_connections.return_value = net_connections
    mock_io_counters.return_value = net_io_counters
    mock_if_addrs.return_value = if_addrs
